...
import 'package:dashboard/widgets/bar_chart_container.dart';
import 'package:dashboard/widgets/custom_app_bar.dart';
import 'package:dashboard/widgets/start_grid.dart';
      ...
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: CovidBarChartContainer(covidCases: covidUSADailyNewCases),
            ),
          ),
        ],
      ),
